...
namespace Dottext.Framework
{
	...
	public class BlogProviderException : ApplicationException 
	{
		public BlogProviderException() {}
		public BlogProviderException(String s) : base(s) {}
		public BlogProviderException(String s, Exception inner) : base(s, inner) {}		
	}

	public class BlogScheduledEventsException : ApplicationException 
	{
		public BlogScheduledEventsException() {}
		public BlogScheduledEventsException(String s) : base(s) {}
		public BlogScheduledEventsException(String s, Exception inner) : base(s, inner) {}		
	}
