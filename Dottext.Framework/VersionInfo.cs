	...
	public class VersionInfo 
	{
		...
		public static Version FrameworkVersion
		{
			get
			{
				if(_version == null)
				{
					string  a = Type.GetType("Dottext.Framework.VersionInfo").Assembly.Location;
		...
		public static string HomePage
		{
			get
			{
				return "http://scottwater.com/blog";
			}
		}
		...
		public static string Version
		{
			get
			{
				return string.Format(".Text Version {0}",FrameworkVersion);
			}
		}
		...
		public static string UserAgent { get { return string.Format("{0} - {1}",Version,HomePage); } }
		public static string Display = "<a href = \"http://Dottext.com\">" + Version + "</a>";
	}
