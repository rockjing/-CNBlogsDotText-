...
//*Scott Watermasysk (http://scottwater.com/blog/archive/2004/02/13/CalendarControl.aspx)
	...
	void Page_Load(object sender, System.EventArgs e)
	{
		...
		entryCal.PrevMonthText = "<a href=\""+CurrentBlog.UrlFormats.MonthUrl(tempDate)+"\">"+CurrentBlog.UrlFormats.MonthUrl(tempDate)+"</a>";
		tempDate = selectedDate.AddMonths(1);
		entryCal.NextMonthText = "<a href=\""+CurrentBlog.UrlFormats.MonthUrl(tempDate)+"\">"+CurrentBlog.UrlFormats.MonthUrl(tempDate)+"</a>";
...
<asp:calendar id="entryCal" runat="server" selectionmode="None"
	daynameformat="FirstLetter" forecolor="#000000" width="180px"  font-names="Verdana" Font-Size="8pt"
	...
	<TodayDayStyle ForeColor="#000000" BackColor="#DDDDDD" Font-Bold="True"></TodayDayStyle>
	<SelectorStyle BackColor="#CCCCCC"></SelectorStyle>
	<NextPrevStyle VerticalAlign="Bottom"></NextPrevStyle>
	<DayHeaderStyle Font-Bold="True" BackColor="#EFEFEF"></DayHeaderStyle>
	<SelectedDayStyle Font-Bold="True" BackColor="#CCCCCC" ForeColor="#000000" BorderStyle="Solid" BorderWidth="1px" BorderColor="#333333"></SelectedDayStyle>
	<TitleStyle Font-Bold="True"  BackColor="#FFFFFF"></TitleStyle>
	<WeekendDayStyle BackColor="#EFEFEF"></WeekendDayStyle>
