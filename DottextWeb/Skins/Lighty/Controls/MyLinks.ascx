...
<ul class="list">
	...
	<li class = "listitem"><asp:HyperLink Runat="server" Text="Ê×Ò³" ID="MyHomeLink" CssClass="listitem"/></li>
	<li class = "listitem"><asp:HyperLink Runat="server" Text="ÐÂËæ±Ê" ID="NewPostLink" CssClass="listitem"/></li>
