...
<TABLE cellSpacing="1" cellPadding="1" border="0">
	<TR>
		<TD><font color="#999966" size="2"><STRONG>Name:</STRONG></font></TD>
		<TD>
			<asp:TextBox id="tbName" Size = "50" runat="server" Width="400px"></asp:TextBox></TD>
	</TR>
	<TR>
		<TD><font color="#999966" size="2"><STRONG>Email:</STRONG></font></TD>
		<TD>
	...
	<TR>
		<TD><font color="#999966" size="2"><STRONG>Subject:</STRONG></font></TD>
		<TD>
			<asp:TextBox id="tbSubject" runat="server" Size = "50" Width="400px"></asp:TextBox></TD>
	</TR>
	<TR>
		<TD><font color="#999966" size="2"><STRONG>Message:</STRONG></font></TD>
		<TD>
