...
<ul>
	...
	<li>
		<asp:HyperLink Runat="server" Text="Ê×Ò³" ID="MyHomeLink" /></li>
	<li>
		<asp:HyperLink Runat="server" Text="ÐÂËæ±Ê" ID="NewPostLink" /></li>
	<li>
...
<span>
	<asp:HyperLink ImageUrl="~/images/xml.gif" Runat="server" NavigateUrl="~/Rss.aspx" ID="XMLLink">RSS 2.0 Feed</asp:HyperLink>
