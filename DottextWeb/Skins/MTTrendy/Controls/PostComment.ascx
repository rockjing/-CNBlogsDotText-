...
<TABLE cellSpacing="1" cellPadding="1"  border="0" >
	<TR>
		<TD width="75"><font color="#CCCC66" size="2"><STRONG>Title</STRONG></font></TD>
		<TD>
	...
	<TR>
		<TD width="75"><font color="#CCCC66" size="2"><STRONG>Name</STRONG></font></TD>
		<TD>
	...
	<TR>
		<TD><font color="#CCCC66" size="2"><STRONG>Url</STRONG></font></TD>
		<TD>
			<asp:TextBox id="tbUrl" runat="server" Size = "40" Width="300px"></asp:TextBox></TD>
		<TD></TD>
	</TR>
	<TR>
			<TD colSpan="3"><font color="#CCCC66" size="2"><STRONG>Comments&nbsp;</STRONG></font>
	...
	<TR>
		<TD colSpan="3"><font color="#CCCC66" size="2">
