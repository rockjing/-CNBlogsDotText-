...
namespace Dottext.Web.UI.Controls
{
	...
	/// </summary>
	public class ViewPicture : Dottext.Web.UI.Controls.BaseControl
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			if(Context != null)
			{
				int imageID = Globals.GetPostIDFromUrl(Request.Path);
				Dottext.Framework.Components.Image _image = Images.GetSingleImage(imageID,true);
