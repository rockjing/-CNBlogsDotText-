...
namespace Dottext.Web.UI.Controls
{
	...
	public  class MonthList : BaseControl
	{
		...
		protected Dottext.Web.UI.Controls.EntryList MonthListings;
		protected override void OnLoad(EventArgs e)
		{
			...
			if(Context != null)
			{
				...
				MonthListings.EntryListItems = Cacher.GetMonth(dt,CacheTime.Medium,Context,PostType.BlogPost);// Entries.GetPostsByDayRange(dt,dt.AddMonths(1),PostType.BlogPost,true);
