...
<ANW:PAGE id="PageContainer" CategoriesLabel="Other Items" TabSectionID="Options" runat="server">
	...
	<ANW:AdvancedPanel id="Edit" runat="server" DisplayHeader="True" HeaderText="Preferences" HeaderCssClass="CollapsibleHeader"
		...
		<P style="MARGIN-TOP: 8px">
			<asp:CheckBox id="EnableMailNotify" runat="Server" Text="允许邮件通知" TextAlign="Left"></asp:CheckBox>&nbsp;
		</P>
		<P style="MARGIN-TOP: 8px">
			<asp:CheckBox id="chkOnlyTitle" runat="Server" Text="首页仅列出标题" TextAlign="Left"></asp:CheckBox>&nbsp;
		</P>
		<P style="MARGIN-TOP: 8px">控件显示设置(选中时显示):</P>
		<P>
