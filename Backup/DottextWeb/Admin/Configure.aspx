...
<%@ Page language="c#" Codebehind="Configure.aspx.cs" AutoEventWireup="false" Inherits="Dottext.Web.Admin.Pages.Configure" %>
<ANW:Page runat="server" id="PageContainer" TabSectionID="Options" CategoriesLabel="Other Items">
	...
	<ANW:AdvancedPanel id="Edit" runat="server" Collapsible="False" HeaderText="Configure" HeaderCssClass="CollapsibleHeader"
		...
		<asp:TextBox id="txbUser" runat="server" width="400" ReadOnly="True"></asp:TextBox>
		<LABEL class="Block">Owner's Display Name</LABEL>
		<asp:TextBox id="txbAuthor" runat="server" width="400"></asp:TextBox>
		<asp:RequiredFieldValidator id="Requiredfieldvalidator2" runat="server" ControlToValidate="txbAuthor" ErrorMessage="显示名称不能为空"></asp:RequiredFieldValidator>
		<LABEL class="Block">Owner's Email</LABEL>
		<asp:TextBox id="txbAuthorEmail" runat="server" width="400"></asp:TextBox>
		<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ControlToValidate="txbAuthorEmail" ErrorMessage="Owner's Email不能为空"></asp:RequiredFieldValidator>
		<LABEL class="Block">回复通知 Email</LABEL>
		<asp:TextBox id="ReplyNotifyMail" runat="server" width="400"></asp:TextBox>
...
Items</LABEL>
		<asp:DropDownList id="ddlItemCount" runat="server" Enabled="False"></asp:DropDownList>
		<LABEL class="Block">Display Skin</LABEL>
		<asp:DropDownList id="ddlSkin" runat="server"></asp:DropDownList>
		<LABEL class="Block">Custom CSS Selectors</LABEL>
