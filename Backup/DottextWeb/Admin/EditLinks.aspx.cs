...
namespace Dottext.Web.Admin.Pages
{
	...
	public class EditLinks : AdminPage
	{
		...
		protected Dottext.Web.Admin.WebUI.AdvancedPanel ImportExport;
		...
		{
			this.ddlImportExportCategories.DataSource = Links.GetCategoriesByType(CategoryType.LinkCollection,false);
		...
		private void BindList()
		{
			...
			{
				LinkCategoryCollection categorys=Links.GetCategoriesByType(CategoryType.LinkCollection,false);
...
//			ImportExport.Visible = false;
		...
		{
			LinkCategoryCollection selectionList = Links.GetCategoriesByType(CategoryType.LinkCollection, false);
