...
namespace Dottext.Framework
{
	...
	public class Links
	{
		...
		public static LinkCollection GetLinkCollectionByPostID(int BlogID,int PostID)
		{
			return DTOProvider.Instance().GetLinkCollectionByPostID(BlogID,PostID);
		}
		...
		public static LinkCategoryCollection GetCategoriesByType(CategoryType catType, bool ActiveOnly)
		{
			return DTOProvider.Instance().GetCategoriesByType(catType,ActiveOnly);
		}

		public static LinkCategoryCollection GetCategoriesByParentID(CategoryType catType, int ParentID,bool ActiveOnly)
		{
			return DTOProvider.Instance().GetCategoriesByParentID(catType,ParentID,ActiveOnly);
		}

		public static LinkCategoryCollection GetCategoriesByType(int BlogID,CategoryType catType, bool ActiveOnly)
		{
			return DTOProvider.Instance().GetCategoriesByType(BlogID,catType,ActiveOnly);
		}

		public static LinkCategoryCollection GetCategoriesWithLinks(bool IsActive)
		{
			return DTOProvider.Instance().GetCategoriesWithLinks(IsActive);
		}
		...
		public static LinkCategory GetLinkCategory(int CategoryID, bool IsActive,int BlogID)
		{
			return DTOProvider.Instance().GetLinkCategory(CategoryID,IsActive,BlogID);
		}
		...
		public static bool DeleteLinkCategory(int CategoryID,int BlogID)
		{
			return DTOProvider.Instance().DeleteLinkCategory(CategoryID,BlogID);
		}
