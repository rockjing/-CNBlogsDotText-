...
namespace Dottext.Framework
{
	public class Images
	{
		...
		public static bool SaveFile(byte[] Buffer, string FileName)
		{
			FileStream fs=null;
		...
		public static void MakeAlbumImages(ref Dottext.Framework.Components.Image _image)
		{
		...
		public static Dottext.Framework.Components.Image GetSingleImage(int imageID, bool ActiveOnly)
		{
			return DTOProvider.Instance().GetSingleImage(imageID,ActiveOnly);
		}

		public static int InsertImage(Dottext.Framework.Components.Image _image,byte[] Buffer)
		{
		...
		public static bool UpdateImage(Dottext.Framework.Components.Image _image)
		{
			return DTOProvider.Instance().UpdateImage(_image);
		}

		// added
		public static void Update(Dottext.Framework.Components.Image _image, byte[] Buffer)
		{
			if(SaveImage(Buffer, _image.OriginalFilePath))
			{
				MakeAlbumImages(ref _image);
		...
		public static void DeleteImage(Dottext.Framework.Components.Image _image)
		{
